...
function dTree(objName) {
	...
	this.icon = {
		...
		folder			: 'TreeImages/heading.gif',

		folderOpen	: 'TreeImages/headingopen.gif',

		node				: 'TreeImages/topic.gif',
...
dTree.prototype.node = function(node, nodeId) {
	...
	str += '<span class="node">'+node.name+'</span>';
...
dTree.prototype.s = function(id) {
	...
	if (cn._hc && this.config.folderLinks) this.o(id);
